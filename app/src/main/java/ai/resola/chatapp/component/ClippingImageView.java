        ...
        if (bmp != null) {
            ...
            if (needRadius) {
                ...
                if (Math.abs(scaleW - scaleH) > 0.00001f) {
                    ...
                    Utils.setRectToRect(shaderMatrix, bitmapRect, roundRect, orientation, Matrix.ScaleToFit.START);
                } else {
                    bitmapRect.set(0, 0, bmp.getWidth(), bmp.getHeight());
                    Utils.setRectToRect(shaderMatrix, bitmapRect, roundRect, orientation, Matrix.ScaleToFit.FILL);
                }
